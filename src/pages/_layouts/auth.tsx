...
export function AuthLayout() {
  return (
    <div>
      <Header />
      <div className="container pt-14 lg:pt-0 h-screen flex-col items-center justify-center antialiased lg:grid lg:min-h-screen lg:max-w-none lg:grid-cols-2 lg:px-0">
